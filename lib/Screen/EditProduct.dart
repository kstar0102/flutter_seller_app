...
//========================= InIt MEthod ========================================
  ...
  void initializaAllvariables() {
    ...
    // Tags
    widget.model!.tagList!.forEach((element) {
      var temp = element;
    ...
    if (widget.model!.isCODAllow != null) {
      isCancelable = widget.model!.isCODAllow;
      iscancelable = widget.model!.isCODAllow == "1" ? true : false;
      if (iscancelable) {
    ...
    if (widget.model!.isCancelable != null) {
      isCODAllow = widget.model!.isCancelable;
      isCODallow = widget.model!.isCancelable == "1" ? true : false;
    }
    //taxincludedinPrice
    if (widget.model!.tax != null) {
      taxincludedinPrice = widget.model!.isCancelable;
      taxincludedInPrice = widget.model!.isCancelable == "1" ? true : false;
    }
    // indicator
    if (widget.model!.indicator != null) {
      indicatorValue = widget.model!.isCancelable;
    }
    //Image
    ...
    if (widget.model!.deliverableZipcodesIds != null) {
      deliverableZipcodes = widget.model!.deliverableZipcodesIds;
    }
    //Description
    ...
    if (widget.model!.otherImage != null) {
      ...
      otherImageUrl = widget.model!.otherImage!;
    }
    // Type Of Product
...
//========================= Simple Product =====================================
    ...
    if (productType == "simple_product") {
      ...
      if (widget.model!.prVarientList![widget.model!.selVarient!].sku != null) {
        simpleproductSKU =
            widget.model!.prVarientList![widget.model!.selVarient!].sku;
        simpleProductSKUController.text =
            widget.model!.prVarientList![widget.model!.selVarient!].sku!;
      }
      // simpleProduct stock
      if (widget.model!.prVarientList![widget.model!.selVarient!].stock !=
          null) {
        simpleproductTotalStock =
            widget.model!.prVarientList![widget.model!.selVarient!].stock;
        simpleProductTotalStock.text =
            widget.model!.prVarientList![widget.model!.selVarient!].stock!;
      }
      ...
      if (widget.model!.attributeList!.isEmpty.toString() == "false") {
        ...
        for (int i = 0; i < index; i++) {
          ...
          _attrController
              .add(new TextEditingController(text: oldattributename));
          ...
          oldListOfAttributeValueID.forEach((element) {
            final tempvar =
    ...
    if (productType == "variable_product") {
          ...
          for (int i = 0; i < index; i++) {
            ...
            oldVariantId = () {
              if (oldVariantId == "") {
                ...
                return oldVariantId! +
                    "," +
                    widget.model!.attributeList![i].id!;
              }
            }();
            String? oldattributename = widget.model!.attributeList![i].name;
            _attrController
      ...
      // if stock management enable then this one .
                ...
                children: [
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                          getTranslated(context, "Select Video From")!,
                          style: Theme.of(this.context)
                              .textTheme
                              .subtitle1!
                              .copyWith(color: fontColor),
    ...
    return Padding(
      ...
      child: InkWell(
        ...
        onTap: () {
          ...
          //productTypeDialog();
          setSnackbar("You can't Change Product Type");
        },
      ),
    );
  }
